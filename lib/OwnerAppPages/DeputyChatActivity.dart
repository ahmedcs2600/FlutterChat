...
class DeputyChatActivityPage extends StatefulWidget {
  final String SchoolUpin, ChatUserID;
  const DeputyChatActivityPage({Key key, this.SchoolUpin, this.ChatUserID}) : super(key: key);

  @override
  _DeputyChatActivityPageState createState() => _DeputyChatActivityPageState();
}

class _DeputyChatActivityPageState extends State<DeputyChatActivityPage> {
